...
<p align="center">
  <a href="https://github.com/tunnckocorehq/mono">
...
**Params**
- `cmds` **{string|string[]}** a commands to execute, if array of strings executes them serially
...
You also can control pass option `concurrency: 1` to run them in series.

**Params**
- `cmds` **{string|string[]}** a commands to execute in parallel or series
- `options` **{object}** directly passed to [execa][] and so to `child_process`
...
<!-- prettier-ignore -->
| [<img src="https://avatars3.githubusercontent.com/u/5038030?v=4" width="120px;"/><br /><sub><b>Charlike Mike Reagent</b></sub>](https://tunnckocore.com)<br />[💻](https://github.com/tunnckocorehq/mono/commits?author=tunnckoCore "Code") [📖](https://github.com/tunnckocorehq/mono/commits?author=tunnckoCore "Documentation") [💬](#question-tunnckoCore "Answering Questions") [👀](#review-tunnckoCore "Reviewed Pull Requests") [🔍](#fundingFinding-tunnckoCore "Funding Finding") |
| :---: |
...
[ghrelease-url]: https://github.com/tunnckocorehq/mono/releases/latest
[ghrelease-img]: https://badgen.net/github/release/tunnckocorehq/mono?icon=github

[license-url]: https://github.com/tunnckocorehq/mono/blob/master/LICENSE
...
[linuxbuild-url]: https://circleci.com/gh/tunnckocorehq/mono/tree/master
[linuxbuild-img]: https://badgen.net/circleci/github/tunnckocorehq/mono/master?label=build&icon=circleci

[codecoverage-url]: https://codecov.io/gh/tunnckocorehq/mono
[codecoverage-img]: https://badgen.net/codecov/c/github/tunnckocorehq/mono?icon=codecov

[dependencies-url]: https://david-dm.org/tunnckocorehq/mono
[dependencies-img]: https://badgen.net/david/dep/tunnckocorehq/mono?label=deps
...
[shareu]: https://twitter.com/intent/tweet?text=https://github.com/tunnckocorehq/mono&via=tunnckoCore
[shareb]: https://badgen.net/badge/twitter/share/1da1f2?icon=twitter
[open-issue-url]: https://github.com/tunnckocorehq/mono/issues/new
